...
function Svg() {
    ...
    // 继承属性
    Selector.call.apply(Selector, __spreadArray([this], arge, false));
    this.svg;
}
// 继承方法
Svg.prototype = new Selector();
Svg.prototype.constructor = Selector;
Svg.prototype.appendSvg = function (tag, attr) {
...
Svg.prototype.intiSvg = function (width, height) {
    if (width === void 0) { width = 100; }
    if (height === void 0) { height = 100; }
    var svg = this.appendSvg("svg", { width: width, height: height });
    this._$.appendChild(svg);
    this.svg = svg;
};
var mySvg = new Svg(".app");
mySvg.intiSvg();
console.log(mySvg);
mySvg.sayHello();
